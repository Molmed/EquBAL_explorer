...
scConf_fullobj = modColours(scConf_fullobj, meta.to.mod = "BAL phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff", "#bdb2ff", "#ffc6ff"))
...
scConf_tcellsobj = modColours(scConf_tcellsobj, meta.to.mod = "BAL phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff", "#bdb2ff", "#ffc6ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_macrophagesobj = modColours(scConf_macrophagesobj, meta.to.mod = "BAL phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff", "#bdb2ff", "#ffc6ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_dendriticobj = modColours(scConf_dendriticobj, meta.to.mod = "BAL phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff", "#bdb2ff", "#ffc6ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_neutrophilsobj = modColours(scConf_neutrophilsobj, meta.to.mod = "BAL phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff", "#bdb2ff", "#ffc6ff"))
print("Making shiny files, selecting default genes to show")
...
scConf_mastcellsobj = modColours(scConf_mastcellsobj, meta.to.mod = "BAL phenotype", new.colours= c("#ffadad", "#ffd6a5", "#fdffb6", "#caffbf", "#9bf6ff", "#a0c4ff", "#bdb2ff", "#ffc6ff"))
print("Making shiny files, selecting default genes to show")
